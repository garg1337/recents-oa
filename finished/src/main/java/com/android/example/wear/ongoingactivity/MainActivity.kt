...
class MainActivity : ComponentActivity() {
    ...
    fun onClickPublishShortcut(view: View) {
        Log.d(TAG, "onClickPublishShortcut()")
        val id = UUID.randomUUID().toString()
        val shortcut = ShortcutInfoCompat.Builder(this, id)
            .setShortLabel("Website $id")
            .setLongLabel("Open the website")
            .setIcon(IconCompat.createWithResource(this, R.drawable.ic_walk))
